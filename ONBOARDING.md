...
## The 21 router slices (alphabetical)
...
| 20 | `sso.py` | 3 | OAuth/OIDC sign-in (providers / start / callback) |
| 21 | `avatar_admin.py` | 3 | Photoreal-avatar provider status + reset |
...
| `scripts/run_accuracy_bench.py` | Lesson-generation regression bench | 310 items across 9 boards/exams |
